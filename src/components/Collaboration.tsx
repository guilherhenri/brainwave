    ...
    <Section crosses>
      <div className="container lg:flex">
        ...
        <div className="mt-4 lg:ml-auto xl:w-[38rem]">
          ...
          <div
            className="relative left-1/2 flex aspect-square w-[22rem] -translate-x-1/2 scale-75
              rounded-full border border-n-6 md:scale-100"
          >
            ...
            <ul>
              {collabApps.map((app, index) => (
                ...
                >
                  <div
                    className={`relative -top-[1.6rem] flex size-[3.2rem] rounded-xl border-n-1/15
                    -rotate-${index * 45}`}
                  >
                    <img
                      src={app.icon}
